...
function AboutMe() {
  ...
  <div className="w-full md:w-1/2 p-4">
    ...
    In addition to his project experience, Abdulmalik is proficient in a variety of programming languages and technologies. He is adept at JavaScript and TypeScript, and is well-versed in backend technologies like Node.js and Express.js. His frontend skills include mastery of React.js and Next.js. He also has extensive knowledge in handling databases like MySQL and MongoDB. His proficiency in these areas allows him to work on existing web apps or build new ones from scratch, depending on the client's needs.
    </p>
